...
<%
	...
	String membersEmail = (String)(session.getAttribute("loginMemberEmail"));
	String ordersAddr = request.getParameter("ordersAddr");
	
	System.out.println(productId + ordersAmount + ordersPrice + membersEmail + ordersAddr+"<=---------------");
	
	Orders orders = new Orders();
	orders.setProductId(productId);
	orders.setOrdersAmount(ordersAmount);
	orders.setOrdersPrice(ordersPrice);
	orders.setMembersEmail(membersEmail);
